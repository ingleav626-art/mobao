 ...
 *   - AI_FEEDBACK_STORAGE_KEY = "mobao_ai_feedbacks_v1"
...
export const AI_FEEDBACK_STORAGE_KEY: string = "mobao_ai_feedbacks_v1"
export const AI_WALLET_STORAGE_KEY: string = "mobao_ai_wallets_v1"
export const APP_STATE_STORAGE_KEY: string = "mobao_app_state_v1"
export const SELECTED_MAP_STORAGE_KEY: string = "mobao_selected_map_v1"
export const SELECTED_CHARACTER_STORAGE_KEY: string = "mobao_selected_character_v1"
export const SHOP_INVENTORY_STORAGE_KEY: string = "mobao_shop_inventory_v1"
export const SHOP_REFRESH_DATE_STORAGE_KEY: string = "mobao_shop_refresh_date_v1"
export const SHOP_LIMITED_OFFER_STORAGE_KEY: string = "mobao_shop_limited_offer_v1"
export const CARRY_ITEMS_STORAGE_KEY: string = "mobao_carry_items_v1"
export const CARRY_AUTO_REPLENISH_STORAGE_KEY: string = "mobao_carry_auto_replenish_v1"
export const MONEY_SETTLED_RUN_STORAGE_KEY: string = "mobao_money_settled_run"
export const LAN_PLAYER_ID_STORAGE_KEY: string = "mobao_lan_player_id"
export const LAN_ROOM_CODE_STORAGE_KEY: string = "mobao_lan_room_code"
export const LAN_PLAYER_NAME_STORAGE_KEY: string = "mobao_lan_player_name"
export const LAN_IS_HOST_STORAGE_KEY: string = "mobao_lan_is_host"
export const LAN_RECONNECT_FAILED_STORAGE_KEY: string = "mobao_lan_reconnect_failed"
export const LAN_NAME_STORAGE_KEY: string = "mobao_lan_name"
