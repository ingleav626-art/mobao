...
export function cacheDom(this: WarehouseSceneThis): void {
  ...
  this.dom.settingLlmFeedbackEnabled = document.getElementById("setting-llmFeedbackEnabled")
  this.dom.viewAiFeedbackBtn = document.getElementById("viewAiFeedbackBtn")
  this.dom.aiFeedbackOverlay = document.getElementById("aiFeedbackOverlay")
  this.dom.aiFeedbackPanel = document.getElementById("aiFeedbackPanel")
  this.dom.aiFeedbackCloseBtn = document.getElementById("aiFeedbackCloseBtn")
  this.dom.aiFeedbackClearBtn = document.getElementById("aiFeedbackClearBtn")
  this.dom.aiFeedbackContent = document.getElementById("aiFeedbackContent")
