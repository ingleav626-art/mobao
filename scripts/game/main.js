...
function settlementRevealDelayByQuality(qualityKey) {
  const multiplier = GAME_SETTINGS.revealSpeedMultiplier;
  switch (qualityKey) {
    case "legendary":
...
function settlementSearchDurationByQuality(qualityKey) {
  const multiplier = GAME_SETTINGS.searchSpeedMultiplier;
  switch (qualityKey) {
    case "legendary":
