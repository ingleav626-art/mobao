...
public class NativeBridge {
    ...
    public void llmProxyAsync(String requestId, String bodyJson) {
        ...
        Log.i(TAG, "[llmProxyAsync] " + requestId + " START, thread created at " + threadStartTime);
        new Thread(() -> {
            final long execStartTime = System.currentTimeMillis();
            final long queueDelay = execStartTime - threadStartTime;
            Log.i(TAG, "[llmProxyAsync] " + requestId + " EXEC START, queue delay: " + queueDelay + "ms");
            try {
                ...
                final long connectElapsed = responseStartTime - connectStartTime;
                ...
                final long totalElapsed = System.currentTimeMillis() - execStartTime;
                Log.i(TAG, "[llmProxyAsync] " + requestId + " COMPLETE, status: " + status + ", total: " + totalElapsed
                        + "ms");
